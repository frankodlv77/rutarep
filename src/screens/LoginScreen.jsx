          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-surface border border-[var(--c-border2)] rounded-xl px-4 pr-11 py-[11px] text-textc text-[14px] outline-none focus:border-amber-400 placeholder:text-muted2 transition-colors"
              />
              <button
                type="button"
                onClick={() => setShowPass(v => !v)}
                className="absolute right-3 top-1/2 -translate-y-1/2 text-muted hover:text-amber-400 transition-colors p-1"
                tabIndex={-1}
              >
                {showPass ? (
