  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        icons: [
          { src: 'icon-vorarep-192.png?v=2', sizes: '192x192', type: 'image/png' },
          { src: 'icon-vorarep-512.png?v=2', sizes: '512x512', type: 'image/png' },
          { src: 'icon-vorarep-maskable.png?v=2', sizes: '512x512', type: 'image/png', purpose: 'maskable' },
        ],
        screenshots: [
          {
